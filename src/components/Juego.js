            ...
            <div className='card-group py-5 wrap col rounded bg-primary bg-opacity-25'>
                <div className='card bg-dark mx-3 rounded'>
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title fw-bold text-info">PIEDRA PAPEL O TIJERAS</h5>
                        <p class="card-text text-center fst-italic fw-bold">
                ...
                <div className='card bg-dark mx-3 rounded'>
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title fw-bold text-info">AHORCADITO</h5>
                        <p class="card-text text-center fst-italic fw-bold">
                ...
                <div className='card bg-dark mx-3 rounded'>
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title fw-bold text-info">ARKANOID</h5>
                        <p class="card-text text-center fst-italic fw-bold">
                ...
                <div className='card bg-dark mx-3 rounded'>
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title fw-bold text-info">JUEGO PHASER</h5>
                        <p class="card-text text-center fst-italic fw-bold">
                ...
                <div className='card bg-dark mx-3 rounded'>
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title fw-bold text-info">TRES EN RAYA</h5>
                        <p class="card-text text-center list-group fst-italic fw-bold">
